...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_PCREL_LO5_VI, 58)
  RELOC_NUMBER (R_RISCV_PCREL_LO5_VS, 59)
  RELOC_NUMBER (R_RISCV_LO5_VI, 60)
  RELOC_NUMBER (R_RISCV_LO5_VS, 61)
  RELOC_NUMBER (R_RISCV_TPREL_LO5_VI, 62)
  RELOC_NUMBER (R_RISCV_TPREL_LO5_VS, 63)
