...
static reloc_howto_type howto_table[] =
{
  ...
  HOWTO (R_RISCV_32_PCREL,		/* type */
	 ...
	 MINUS_ONE,			/* dst_mask */
	 FALSE),			/* pcrel_offset */
    /* Low 5 bits of a 32-bit PC-relative load or add.  */
  HOWTO (R_RISCV_PCREL_LO5_VI,		/* type */
	 0,				/* rightshift */
         2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,		/* special_function */
	 "R_RISCV_PCREL_LO5_VI",	/* name */
	 FALSE,				/* partial_inplace */
	 0,				/* src_mask */
	 ENCODE_VITYPE_IMM (-1U),	/* dst_mask */
	 FALSE),			/* pcrel_offset */

  /* Low 5 bits of a 32-bit PC-relative store.  */
 HOWTO (R_RISCV_PCREL_LO5_VS,		/* type */
	 0,				/* rightshift */
	 2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,		/* special_function */
	 "R_RISCV_PCREL_LO5_VS",	/* name */
	 FALSE,				/* partial_inplace */
	 0,				/* src_mask */
	 ENCODE_VSTYPE_IMM (-1U),	/* dst_mask */
	 FALSE),			/* pcrel_offset */

      /* High 5 bits of 32-bit load or add.  */
  HOWTO (R_RISCV_LO5_VI,		/* type */
	 0,				/* rightshift */
	 2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
  ...
  /* High 5 bits of 32-bit store.  */
  HOWTO (R_RISCV_LO5_VS,		/* type */
	 0,				/* rightshift */
	 2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
  ...
  /* Low 5 bits of TLS LE thread pointer offset for loads and adds.  */
  HOWTO (R_RISCV_TPREL_LO5_VI,		/* type */
	 0,				/* rightshift */
	 2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,		/* special_function */
	 "R_RISCV_TPREL_LO5_VI",	/* name */
	 FALSE,				/* partial_inplace */
	 0,				/* src_mask */
	 ENCODE_VITYPE_IMM (-1U),	/* dst_mask */
	 FALSE),			/* pcrel_offset */

  /* Low 5 bits of TLS LE thread pointer offset for stores.  */
  HOWTO (R_RISCV_TPREL_LO5_VS,		/* type */
	 0,				/* rightshift */
	 2,				/* size */
	 32,				/* bitsize */
	 FALSE,				/* pc_relative */
...
static const struct elf_reloc_map riscv_reloc_map[] =
{
  ...
  { BFD_RELOC_RISCV_PCREL_LO5_VI, R_RISCV_PCREL_LO5_VI },
  { BFD_RELOC_RISCV_PCREL_LO5_VS, R_RISCV_PCREL_LO5_VS },
  { BFD_RELOC_RISCV_LO5_VI, R_RISCV_LO5_VI },
  { BFD_RELOC_RISCV_LO5_VS, R_RISCV_LO5_VS },
  { BFD_RELOC_RISCV_TPREL_LO5_VI, R_RISCV_TPREL_LO5_VI },
  { BFD_RELOC_RISCV_TPREL_LO5_VS, R_RISCV_TPREL_LO5_VS },
};
