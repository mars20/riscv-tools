...
static const char *const bfd_reloc_code_real_names[] = { "@@uninitialized@@",
  ...
  "BFD_RELOC_RISCV_PCREL_LO5_VI",
  "BFD_RELOC_RISCV_PCREL_LO5_VS",
  "BFD_RELOC_RISCV_LO5_VI",
  "BFD_RELOC_RISCV_LO5_VS",
  "BFD_RELOC_RISCV_TPREL_LO5_VI",
  "BFD_RELOC_RISCV_TPREL_LO5_VS",
  "BFD_RELOC_RL78_NEG8",
