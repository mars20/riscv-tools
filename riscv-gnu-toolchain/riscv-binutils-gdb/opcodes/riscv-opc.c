...
/* Vector instructions */
{"vlsd",       "64V", "N,O(s),M", MATCH_VLSD, MASK_VLSD | MASK_RS2, match_opcode, INSN_ALIAS },
{"vlsd",       "64V", "N,O(s),t,M", MATCH_VLSD, MASK_VLSD, match_opcode, 0 },
{"vssd",       "64V", "G,J(s),M",  MATCH_VSSD, MASK_VSSD | MASK_RS2, match_opcode, INSN_ALIAS },
{"vssd",       "64V", "G,J(s),t,M",  MATCH_VSSD, MASK_VSSD, match_opcode, 0 },
{"vlxd",       "64V", "N,O(s),H,M", MATCH_VLXD, MASK_VLXD, match_opcode, 0 },
{"vsxd",       "64V", "G,J(s),H,M",  MATCH_VSXD, MASK_VSXD, match_opcode, 0 },
{"vadd",       "64V", "N,B,H,M", MATCH_VADD, MASK_VADD, match_opcode, 0},
{"vmul",       "64V", "N,B,H,M", MATCH_VMUL, MASK_VMUL, match_opcode, 0},
{"vmadd",      "64V", "N,B,H,G,M", MATCH_VMADD, MASK_VMADD, match_opcode, 0},
{"vfadd",      "64V", "N,B,H,M", MATCH_VFADD, MASK_VFADD, match_opcode, 0},
{"vfmul",      "64V", "N,B,H,M", MATCH_VFMUL, MASK_VFMUL, match_opcode, 0},
{"vfmadd",     "64V", "N,B,H,G,M", MATCH_VFMADD, MASK_VFMADD, match_opcode, 0},
{"vredsum",    "64V", "N,B", MATCH_VREDSUM, MASK_VREDSUM, match_opcode, 0},
{"vredmax",    "64V", "N,B", MATCH_VREDMAX, MASK_VREDMAX, match_opcode, 0},
{"vredmin",    "64V", "N,B", MATCH_VREDMIN, MASK_VREDMIN, match_opcode, 0},
{"vsplat",     "64V", "N,B,t,M", MATCH_VSPLAT, MASK_VSPLAT, match_opcode, 0},
{"vfredsum",   "64V", "N,B", MATCH_VFREDSUM, MASK_VFREDSUM, match_opcode, 0},
{"vmax",       "64V", "N,B,H", MATCH_VMAX, MASK_VMAX, match_opcode, 0},
{"vmin",       "64V", "N,B,H", MATCH_VMIN, MASK_VMIN, match_opcode, 0},
{"vfmax",      "64V", "N,B,H", MATCH_VFMAX, MASK_VFMAX, match_opcode, 0},
{"vfmin",      "64V", "N,B,H", MATCH_VFMIN, MASK_VFMIN, match_opcode, 0},
{"vbcastx",    "64V", "N,s", MATCH_VBCASTX, MASK_VBCASTX, match_opcode, 0},
{"vbcastf",    "64V", "N,S", MATCH_VBCASTF, MASK_VBCASTF, match_opcode, 0},
{"vmerge",     "64V", "N,B,H,M", MATCH_VMERGE, MASK_VMERGE, match_opcode, 0},
{"vinsx",      "64V", "N,s,t,M", MATCH_VINSX, MASK_VINSX, match_opcode, 0},
